	...
	const perretes = [
		{
			...
			nombre: "coquito",
			ojitos: "ojitos cuquis y marrones",
			aficiones: "le gusta jugar a la pelota y dormir",
			raza: "border collie",
		...
		},
		{
			...
			nombre: "croqueta",
			ojitos: "color miel",
			aficiones: "le gusta correr y  dar besos",
			raza: "mezcla de chiquitito y adorable",
		},
		{
			id: 3,
			...
			nombre: "media noche",
			ojitos: "azul marino oscuro",
			aficiones: "se pone complementos a la  moda y le gusta tumbarse",
			raza: "mezcla de ricitos y moda",
		...
		},
		{
			...
			nombre: "manchitas",
			ojitos: "verdes oscuros",
			aficiones: "pasear y perseguir su cola",
			raza: "chocolate con leche",
			...
			nombre: "coco",
			ojitos: "azul oscuro",
			aficiones: "tumbarse boca arriba",
			raza: "pimche",
		...
		},
		{
			...
			nombre: "calcetines",
			ojitos: "ojitos felices",
			aficiones: "saltar en los charcos de barro",
			raza: "braco",
